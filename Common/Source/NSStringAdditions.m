	...
	if (length > 3 &&
       [self rangeOfString:@"." options:NSLiteralSearch].location != NSNotFound) {
		...
		if (!TLD2) {
			...
			TLD3 = [NSArray arrayWithObjects:@".com",@".edu",@".gov",@".int",@".mil",@".net",@".org",@".biz",@".",@".pro",@".cat", nil];
			TLD4 = [NSArray arrayWithObjects:@".info",@".aero",@".coop",@".mobi",@".jobs",@".arpa", nil];
		}
...
{
    return [[self mutableCopy] escapeForHTML];
}
